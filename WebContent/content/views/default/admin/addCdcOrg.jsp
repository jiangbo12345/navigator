...
<body>
	<form class="form-horizontal" action="./addCdcOrg" method="POST">
		<div class="form-group" style="text-align: center;">
			<label><font style="font-size: 40px;">CDC机构添加</font> </label> <br>
			<br>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="cdcOrgDesignation" class="form-control"
					id="inputEmail3" value="${cdcOrg.cdcOrgDesignation }">
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-2 control-label"><a
